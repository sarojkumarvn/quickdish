      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="h-5 w-5 text-orange-400 mr-3 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div>
            ...
            <form className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors duration-300"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-gray-800 rounded-xl p-6 mb-12">
          <div className="mb-6 md:mb-0 md:mr-6">
            ...
            <p className="text-gray-300 mb-4">
              Get exclusive offers and order on the go!
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              >
                <img className="h-6 w-6 mr-2 text-white" src="/src/assets/appstore.png" alt="" />
                App Store
              </a>
              <a
                href="#"
